    ...
    lostItems.forEach(item => {
        ...
        div.innerHTML = `
            ...
            <div class="lost-item-info-new">
                ...
                <div class="lost-item-cell">Ячейка: ${formatCellDisplay(item.cell || currentOrder.cell)}</div>
                ...
                <button class="lost-item-btn-new" data-code="${item.code}">ШК поврежден</button>
            </div>
        `;
    ...
    list.querySelectorAll('.lost-item-btn-new').forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            if (item) {
                ...
                const newLostCount = currentOrder.items.filter(i => i.isLost).length;
                if (newLostCount === 0) {
                    toggleModal('courier-lost-alert-modal', false);
                    showOrderViewScreen();
                } else {
